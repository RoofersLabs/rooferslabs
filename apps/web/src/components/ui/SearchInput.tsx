  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <input
        ref={ref}
        type="search"
        className="focus-ring h-10 w-full rounded-md border border-line bg-surface pl-9 pr-3 text-form-input text-ink transition-colors duration-fast ease-standard placeholder:text-ink-faint hover:border-line-strong"
        {...props}
      />
    </div>
  );
