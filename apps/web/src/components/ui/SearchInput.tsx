  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <input
        ...
        type="search"
        className={cn(
          'focus-ring h-10 w-full border border-line bg-surface pl-9 pr-3 text-form-input text-ink transition-colors duration-fast ease-standard placeholder:text-ink-faint hover:border-line-strong',
          inputClassName,
        )}
        {...props}
      />
