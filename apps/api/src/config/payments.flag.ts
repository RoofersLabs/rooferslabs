 ...
 *
 * Only the active provider's list is enforced (see env.validation.ts). Keyed by
 * the enum so a future second provider cannot be added without declaring what
 * it needs — the compiler asks the question.
 */
