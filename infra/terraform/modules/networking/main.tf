# =============================================================================
# Networking — VPC, public/private subnets across two AZs, IGW, NAT
# =============================================================================
# Public subnets host the ALB and NAT gateway; private subnets host ECS tasks,
# RDS, and ElastiCache. A single NAT gateway is the cost-conscious default for
# the MVP; set single_nat_gateway = false for one per AZ.
